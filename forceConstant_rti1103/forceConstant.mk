...
#    J. Hagendorf
#
#  (c) Copyright 2009, dSPACE GmbH. All rights reserved.
#
#  $RCSfile: forceConstant.mk $ $Revision: 2.39 $ $Date: 2009/11/23 16:13:00CET $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Distribution/MATLAB/RTI1103/M/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 140
# =============================================================================
...
MATLAB_BIN                     = C:\Program Files (x86)\MATLAB\R2010a\bin
MATLAB_ROOT_ALT                = C:\PROGRA~2\MATLAB\R2010a
MATLAB_BIN_ALT                 = C:\PROGRA~2\MATLAB\R2010a\bin
RELEASE_VERSION                = R2010a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = forceConstant
MODULES                        = forceConstant_data.c forceConstant_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
#
MSG_OPTS = -nQi -QmsC0001 -Qms0111 -QmsC0177 -QmsC0186 -QmsC0188 -QmsC0191 -QmsC0193 -QmwC0223 -QmeC0233 -QmsC0236 -QmsC0237 -QmwC0260 -QmsC0340 -QmsC0381 -QmsC0514 -Qms0550 -QmsC0826 -Qms1430 -Qms1457
...
RTWCUST_INCLUDES = \
	$(START_DIR)\forceConstant_rti1103 \
	$(START_DIR) \
	$(START_DIR)\forceConstant
...
LNK_OPTS = -QmsA0407 -QmsA0314 -QmeA0307 -QmeA0329
...
$(MODEL).$(CC_OBJ_EXT) $(MODULE_OBJS) : $(MODEL_DEP_FILES)
...
%.i : %.$(CC_SRC_EXT)
	...
	%set PP_CMD = "$(CC,"=)" -P $(CC_FLAGS) $(.SOURCE)
