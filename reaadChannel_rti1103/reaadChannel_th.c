/************************ dSPACE target specific file *************************
   ...
   Include file .\reaadchannel_rti1103\reaadChannel_th.c :

   Task Configuration file for model : reaadChannel

   RTI1103 6.5 (10-May-2010)/2.2
   08-Sep-2016 14:15:04
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\reaadchannel_rti1103\reaadChannel_th.c is for ST).
# endif
