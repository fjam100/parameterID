...
#
#  $RCSfile: input_output.mk $ $Revision: 2.39 $ $Date: 2009/11/23 16:13:00CET $
...
COMPUTER                       = PCWIN
MODEL                          = input_output
MODULES                        = input_output_data.c input_output_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = input_outputlib.lib
...
RTWCUST_INCLUDES = \
	$(START_DIR)\input_output_rti1103 \
	$(START_DIR)
