/************************ dSPACE target specific file *************************
   ...
   Include file .\input_output_rti1103\input_output_th.c :

   Task Configuration file for model : input_output

   RTI1103 6.5 (10-May-2010)/2.2
   05-Sep-2016 14:08:31
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\input_output_rti1103\input_output_th.c is for ST).
# endif
