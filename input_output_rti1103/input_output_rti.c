/*********************** dSPACE target specific file *************************
   ...
   Include file input_output_rti.c:
...
#define RTB_STRUCTURE_NAME             input_output_B
#define RTP_STRUCTURE_NAME             input_output_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  input_output_B.SFunction1 = (real_T) ds1103_inc_position_read(3,
